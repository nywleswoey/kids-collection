...
- **Current Stage**: INCREMENT 6 (Missing-Card Names & Easter-Egg Pick) — INCEPTION / Application Design (drafted, AWAITING APPROVAL). Reqs APPROVED (refund-on-abandon + pick roulette).
