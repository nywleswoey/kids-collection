...
- **Current Stage**: CONSTRUCTION - U1 NFR Design COMPLETE (awaiting approval to start U1 Infrastructure Design)
...
- [ ] **U1 Foundation & Data** — [x] Functional Design → [x] NFR Req → [x] NFR Design → Infra Design (next) → Code Gen
- [ ] U2 Auth & Profiles
- [ ] U3 Pool & Seeding
- [ ] U4 Pull & Rewards
- [ ] U5 Binder
