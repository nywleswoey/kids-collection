...
- **Current Stage**: CONSTRUCTION - U1 NFR Requirements COMPLETE (awaiting approval to start U1 NFR Design)
...
- [ ] **U1 Foundation & Data** — [x] Functional Design → [x] NFR Req → NFR Design (next) → Infra Design → Code Gen
- [ ] U2 Auth & Profiles
- [ ] U3 Pool & Seeding
- [ ] U4 Pull & Rewards
- [ ] U5 Binder
