...
### 🟡 OPERATIONS
- [x] Operations gate — Q7=A: pushed main → Vercel prod (code commit 1268c06). Migration 0006 already applied at Build & Test; no post-deploy seed needed.
