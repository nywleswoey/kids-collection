...
- [x] **Step 1 — Seed schema + sample data**
...
- [x] **Step 2 — claude.ai authoring prompt**
...
- [x] **Step 3 — Loader/validator + prompt builder**
...
- [x] **Step 4 — Image generator (Pollinations) + Blob uploader**
...
- [x] **Step 7 — Runtime CardPool reader**
